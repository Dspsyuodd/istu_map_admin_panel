...
BuildingModel _$BuildingModelFromJson(Map<String, dynamic> json) =>
    BuildingModel(
      ...
      floors: (json['Floors'] as List<dynamic>)
          .map((e) =>
              FloorInfoModel.fromJson(e as Map<String, dynamic>) as FloorInfo)
          .toList(),
      description: json['Description'] as String?,
      address: json['Address'] as String,
      latitude: (json['ExternalPosition']['Latitude'] as num).toDouble(),
      longitude: (json['ExternalPosition']['Longitude'] as num).toDouble(),
    );
